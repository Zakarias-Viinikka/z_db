...
use protocol::payload::{ColumnSource, FundamentallyEditExistingColIn};
...
pub fn update_from_old_version(db_wrapper: &LiveForever) {
    db_wrapper
        .fundamentally_edit_existing_col(FundamentallyEditExistingColIn {
            ...
            new_column: not_null_col(ColumnType::Text, "title"),
...
pub fn table2_columns() -> Vec<ColumnDef> {
    vec![id_column(), not_null_col(ColumnType::Text, "title")]
}
